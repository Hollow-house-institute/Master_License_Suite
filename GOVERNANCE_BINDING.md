# Governance Binding — Master License Suite
...
## Binding Rules
- Terms must not be redefined locally  
- Terms must not be paraphrased into alternate meanings  
- Terminology remains anchored to the Semantic Layer  

## Governance Alignment
This repository operates at the Execution Layer and enforces constraints only.
